...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference("Balance.count") do
      post balances_url, params: { balance: { user_balance: @balance.user_balance } }, as: :json
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { user_balance: @balance.user_balance } }, as: :json
    assert_response :success
  end
